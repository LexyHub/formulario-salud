...
export default function Input({
  ...
  return (
    <div className="flex flex-col items-start justify-start gap-y-2 text-sm md:text-base font-archivo text-lexy-text">
      ...
      <div
        className={clsx("border border-lexy-border-input rounded-sm transition-colors px-4 py-2 h-10 w-full", className, {
      ...
      >
        <input
          ...
          className="bg-transparent outline-none border-none w-full placeholder:text-lexy-text-disabled font-archivo text-sm leading-5"
          id={id}
          value={value}
