  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
      <Input
        ...
        value={form.nombres}
        onChange={(val) => setField("nombres", val)}
      />
      <Input
        id='apellidos'
        label='Apellidos'
        placeholder='Ingresa todos tus apellidos'
        required
        error={errors.apellidos}
        value={form.apellidos}
        onChange={(val) => setField("apellidos", val)}
      />
      <Input
        id='rut'
        label='RUT'
      ...
      <SearchableSelect
        ...
        required
        notFound='No se ha encontrado la región indicada'
      ...
      <SearchableSelect
        ...
        notFound='No se ha encontrado la comuna indicada'
        options={comunaOptions}
        error={errors.comuna}
        value={form.comuna}
        onChange={(val) => setField("comuna", val)}
      />
      <Input
        id='domicilio'
        label='Domicilio'
        placeholder='Calle y número (Ej: C.5 Los Cóndores)'
        required
        disabled={form.comuna === ""}
        error={errors.domicilio}
        value={form.domicilio}
        onChange={(val) => setField("domicilio", val)}
      />
    </div>
  );
}
